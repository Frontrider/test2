...
public abstract class OneWayPlatform
{
    ...
    public static void buildShapes(Map map, float pixels, World world) {
        ppt = pixels;
        MapObjects objects = map.getLayers().get("OneWayPlatform").getObjects();
        ...
        for(MapObject object : objects) {
            ...
            try
            {
                ...
                body.createFixture(fixtureDef).setUserData(StaticVariables.ONE_WAY_PLATFORM);

                //Gdx.app.log(LOG_TAG, "platform loaded");
                shape.dispose();
            }
            catch (Exception e)
            {}
